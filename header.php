        ...
        <div class="row align-items-center">
          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            ...
            <!--    <li class="has-children">
                ...
                <li><button class="btn text-white roundedd fs-3"  style="background-color: #691C32; text-transform: capitalize;"><a href="./bookAppointment.php" class="text-white"><b>Book Appointment</b></a> </button></li>
              </ul>
            </nav>
          </div>
